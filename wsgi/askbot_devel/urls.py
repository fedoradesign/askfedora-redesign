...
#from askbot import views as askbot_views
#from askbot_devel import views
...
urlpatterns += patterns('',
    ...
    #url(r'^questions/$', askbot_views.readers.questions, {'signup_form': YourSignupForm}, name='userena_signup'),
    #url(
    #    r'/questions',
    #    views.readers.questions,
    #    name='questions'
    #),
    #url(r'^/', include('askbot.urls')),
)
